        ...
        <>
          <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm flex flex-col gap-2">
            <div className="flex flex-col gap-4">
              ...
              <h1 className="text-xl font-bold text-gray-900">Book's Title</h1>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm flex flex-col gap-1">
            <button 
              ...
              className="flex items-center gap-3 w-full px-2 py-1.5 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-md transition-colors text-sm hover:font-semibold"
            >
